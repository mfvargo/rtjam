...
#include <math.h>
#include <fftw3.h>      // http://micro.stanford.edu/wiki/Install_FFTW3
#include "Effect.hpp"
#include "BiQuad.hpp"
//#include "YinAcf.hpp"
...
public:
  ...
  //  yin.build(w, tmax);
    ...
    //m_fftOut = (fftw_complex*) fftw_malloc(sizeof(fftw_complex)*256);
     ...
     m_fftPlan = fftw_plan_dft_r2c_1d(s_fftSize, m_fftIn, m_fftOut, FFTW_FORWARD);
  ...
  void process(const float *input, float *output, int framesize) override
  {
    ...
    // Fs = 48000, N = 64 - 750Hz bin
     float peakBinFreq = (p + float(maxBinNumberIndex)) * 1000/s_fftSize;
