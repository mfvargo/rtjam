...
private:
    ...
    int m_codecRegDataP0[20][2] = {{7, 0x0A}, {8, 0xC0}, {9, 0x30}, {14, 0x80}, {18, 0x0F}, {19, 0x04}, {22, 0x04}, {25, 0x80}, {37, 0xC0}, {43, 0x00}, {44, 0x00}, {47, 0x80}, {51, 0x0F}, {64, 0x80}, {65, 0x0F}, {82, 0x80}, {86, 0x09}, {92, 0x80}, {93, 0x09}, {101, 0x01}};

    int m_codecRegDataP1[12][2] = {{65, 0x7F}, {66, 0xE9}, {67, 0x80}, {68, 0x17}, {69, 0x7F}, {70, 0xD4}, {71, 0x7F}, {72, 0xE9}, {73, 0x80}, {74, 0x17}, {75, 0x7F}, {76, 0xD4}};
